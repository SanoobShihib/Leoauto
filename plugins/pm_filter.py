...
async def next_page(bot, query):
    ...
    try:
        if settings['auto_delete']:
            btn.insert(0, 
            [
                InlineKeyboardButton(f'🔻ɪɴғᴏ🔻', 'tips'),
    ...
    btn.insert(2, [
        InlineKeyboardButton("📂 sᴇɴᴅ ᴀʟʟ ғɪʟᴇs 📂", callback_data=f"send_all#{req}#{key}#{pre}")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url="https://t.me/AkFilms2022") ] ] ))
                else:
                    await query.answer(f"𝖧𝖾𝗒 {query.from_user.first_name}, 𝖳𝗁𝗂𝗌 𝗂𝗌 𝗇𝗈𝗍 𝗒𝗈𝗎𝗋 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 !", show_alert=True)
        ...
        await query.answer("ʜᴇʏ ʙʀᴏ ❤️‍🩹💋\n\n🔻ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛʜᴇ ғɪʟᴇs ʏᴏᴜ ᴡᴀɴᴛ ᴀɴᴅ sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ🔻", True)

    elif query.data == 'info':
        await query.answer("𝗥𝗲𝗾𝘂𝗲𝘀𝘁𝘀 𝗙𝗼𝗿𝗺𝗮𝘁𝘀\n\n• ʟᴇᴏ 2023\n• ᴅʜᴏᴏᴍ  3 ʜɪɴᴅɪ\n• ʟᴇᴏ ᴍᴀʟᴀʏᴀʟᴀᴍ\n• ʟᴀsᴛ ᴏғ ᴜs s01\n• ʟᴀsᴛ ᴏғ ᴜs 720𝗉\n• ғʀɪᴇɴᴅs s03 1080𝗉\n\n‼️𝗗𝗼𝗻𝘁 𝗮𝗱𝗱 𝘄𝗼𝗿𝗱𝘀 & 𝘀𝘆𝗺𝗯𝗼𝗹𝘀  , . - 𝗹𝗶𝗸𝗲 send link movie series 𝗲𝘁𝗰‼️", True)
    
    elif query.data == 'tips':
        await query.answer("ᴛʜɪs ᴍᴇssᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 5 ᴍɪɴᴜᴛᴇs ᴛᴏ ᴘʀᴇᴠᴇɴᴛ ᴄᴏᴘʏʀɪɢʜᴛ !\n\nᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ᴜsɪɴɢ ᴍᴇ ❤️‍🩹🫂\n\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄs ᴛᴇᴀᴍ", True)
        ...
        buttons = [[
            InlineKeyboardButton('ғɪʟᴛᴇʀs ᴍᴏᴅᴇ ⚙️', callback_data='filters'),
            InlineKeyboardButton('ғɪʟᴇ sᴛᴏʀᴇ 📂', callback_data='store_file')
        ], [
            InlineKeyboardButton('ᴄᴏɴɴᴇᴄᴛɪᴏɴs 🔗', callback_data='coct'),
            InlineKeyboardButton('ᴇxᴛʀᴀ ᴍᴏᴅᴇs ⚙️', callback_data='extra')
        ], [
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("ᴄᴏɴᴛᴀᴄᴛ 📞", url="t.me/Sanoob_Achu_18")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>👋 ʜᴇʏ {message.from_user.mention}\n📁 ʏᴏᴜʀ ғɪʟᴇs ᴀʀᴇ ʀᴇᴀᴅʏ\n\n📢 ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄs ᴛᴇᴀᴍ</b>"
